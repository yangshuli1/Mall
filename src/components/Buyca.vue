      ...
      <div class="content mar_20">
        <div class="two_bg">
          ...
          <table border="0" style="width:900px; margin-top:20px;" cellspacing="0" cellpadding="0">
            ...
            <tr height="70">
              <td align="right"><span v-on:click="str"><img src="/static/images/btn_sure.gif" /></span></td>
            </tr>
          </table>
...
<script>
  export default {
    ...
    data() {
      return {
        data:[],
        nerder:localStorage.getItem("nerder"),
        totalp:0,
        name:'',
        oder:''
      }
    ...
    mounted() {
      axios.post(this.url+'/orderadd',{
        nerder:this.nerder,
        token: localStorage.getItem("token")
      })
        .then(response=> {
          this.data=response.data.data
          this.name=response.data.name[0].user_address
      ...
      str(){
        ...
        axios.post(this.url+'/order',{
          ...
          .then(response=> {
            ...
            var totalp=this.totalp
            console.log(response)
            location.href="http://localhost/laravel/blog/public/api/pay?token="+token+"&oid="+response.data+"&totalp="+totalp
